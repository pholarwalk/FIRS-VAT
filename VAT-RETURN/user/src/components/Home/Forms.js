...
class Forms extends React.Component {
  constructor(props) {
    ...
    this.handlenum11Change = this.handlenum11Change.bind(this);
  ...
  handlenum11Change(evt) {
    console.log(typeof evt.target.value);
    this.setState({ num11: Number(evt.target.value) });
  }
  addAction = event => {
    let x =
      this.state.num - (this.state.num1 + this.state.num2 + this.state.num3);
  ...
  addAction7 = event => {
    let f = this.state.result100 + this.state.num11;
    this.setState({ result135: f });
  };
  addAction8 = event => {
    let g = -this.state.result115 + this.state.result135;
    this.setState({ result140: g });
  };
  addAction9 = event => {
    let i = this.state.result135 - this.state.result140;
    this.setState({ result145: i });
  };
  addAction10 = event => {
    let j = this.state.result115 + this.state.result140;
    this.setState({ result150: j });
  };
  render() {
    return (
      <div className="full-form">
        ...
        <Form>
          ...
          <FormGroup row>
            ...
            <Label for="exampleEmail" sm={6}>
              Less: Zero Rated Goods & Services Included in line 10
            </Label>
            <Col sm={5}>
              <Input
          ...
          <FormGroup row>
            ...
            <Col sm={6}>
              <Button
                ...
                type="button"
                value="Sales/Income Subject to VAT"
              >
        ...
        <Form>
          ...
          <FormGroup row>
            ...
            <Col sm={6}>
              <Button
                outline
                color="secondary"
                onClick={this.addAction1}
                type="button"
                value="VAT Suffered on VATable Domestic Supplies"
              >
          ...
          <FormGroup row>
            ...
            <Col sm={6}>
              <Button
                outline
                color="secondary"
                onClick={this.addAction2}
                type="button"
                value="VAT Suffered on Zero-Rated Supplies"
              >
          ...
          <FormGroup row>
            ...
            <Col sm={6}>
              <Button
                outline
                color="secondary"
                onClick={this.addAction3}
                type="button"
                value="Total Purchases Subject to VAT Incurred"
              >
          ...
          <FormGroup row>
            ...
            <Col sm={6}>
              <Button
                onClick={this.addAction5}
                type="button"
                value="VAT Balance for Current Period"
              >
                OUTPUT-INPUT
              </Button>
            </Col>
        ...
        <Form>
          ...
          <FormGroup row>
            ...
            <Col sm={5}>
              <Input
                onChange={this.handlenum11Change}
                type="number"
                name="number"
                id="exampleNumber"
                placeholder="NAIRA"
          ...
          <FormGroup row>
            ...
            <Col sm={6}>
              <Button
                outline
                color="secondary"
                onClick={this.addAction7}
                type="button"
                value="Total VAT Credit"
              >
                Total VAT Credit
              </Button>
            </Col>
          ...
          <FormGroup row>
            ...
            <Col sm={6}>
              <Button
                outline
                color="secondary"
                onClick={this.addAction8}
                type="button"
                value="Relieved VAT Credit"
              >
                Relieved VAT Credit
              </Button>
            </Col>
          ...
          <FormGroup row>
            ...
            <Col sm={6}>
              <Button
                outline
                color="secondary"
                onClick={this.addAction9}
                type="button"
                value="VAT Credit Carry Forward"
              >
          ...
          <FormGroup row>
            <Label sm={1}>150 </Label>
            <Col sm={6}>
              <Button onClick={this.addAction10}>VAT Payable</Button>
            </Col>
            <Col sm={5}>
              <Input
                value={this.state.result150}
                readOnly
                type="text"
                name="number"
                id="exampleNumber"
